...
Review the **diff of tests** (and missing tests for new behavior). First apply [repo-profiles.md](repo-profiles.md), then this rubric plus **one** stack file from the qa-test-writer stack list (`ui-unit.md`, `cypress.md`, `playwright.md`, `backend-unit.md`, `contract-pact.md`, `deployment.md`, `java-selenium.md`).
